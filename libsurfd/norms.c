...
static void get_norm(double x1,double y1,double z1,double x2,double y2,double z2,
	double x3,double y3,double z3,double *n)
{
/*
 double z12,z23,z31;
 z31=z3-z1;
...
static void compute_normals_compact(sl_surface_t *surf)
{
 ...
 sl_norm_t *n1,*n2,*n3,*n4,*norm;
 UCHAR *p1,*p2,*p3,*p4;
 double n[3],len,dx,dy,dz,x1,y1,z1,x2,y2,z2,x3,y3,z3,x,y;
#ifdef DEBUG
